    ...
    function h(a, b, e) {
        ...
        d.support.rgba &&
            (c +=
                "," +
                (a && b
                    ? parseFloat(a[3] + e * (b[3] - a[3]))
                    : 1));
        return c + ")";
    }
    function f(a) {
        var b;
        return (b = /#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})/.exec(
            a,
        ))
            ? [
                  parseInt(b[1], 16),
            ...
            : (b = /#([0-9a-fA-F])([0-9a-fA-F])([0-9a-fA-F])/.exec(
                  a,
              ))
            ? [
                  17 * parseInt(b[1], 16),
            ...
            : (b = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(
                  a,
              ))
            ? [
                  parseInt(b[1]),
            ...
            : (b = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9\.]*)\s*\)/.exec(
                  a,
              ))
            ? [
                  parseInt(b[1], 10),
